...
object DarkColors : BarikThemeColor {
  ...
  override val textSuccess = Color(0xFF98DA79)
  override val textLucked = Color(0xFFF6C82B)
  override val textInfo = Color(0xFF646872)
  override val textDanger = Color(0xFFE85450)

  override val background = Color(0xFF000000)
  override val textDefault = Color.White
  override val textSubtle = Color(0xFFEDEEEF)
  override val textSubtlest = Color(0xFFBBBDC1)
  ...
  override val iconSeparator = Color(0xFF6E737C)
  ...
  private val SurfacePageSubtlest = Color(0xFF242B38)
  ...
  override val scheme = darkColorScheme(
    ...
    surfaceContainerLow = SurfacePageSubtlest,
    surfaceContainerHigh = IconsClearer,

    background = background,
    onBackground = textDefault,

    surface = SurfacePageSubtlest,
